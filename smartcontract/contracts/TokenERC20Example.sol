...
contract TokenERC20Example is ERC20, AccessControl, IERC1363 {
    using Address for address;
    
    bytes32 public constant OPERATOR_ROLE = keccak256("OPERATOR_ROLE");

    /**
     * @dev Simple constructor to create a new ERC20 token for VNG Starter
     */
    ...
    /**
     * @dev Mint new tokens and add to specified account. Can only be called by the operator.
     */
